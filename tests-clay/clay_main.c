...
static const struct clay_func _all_callbacks[] = {
	...
	{"single_file", &test_index_rename__single_file, 8},
	{"parsing", &test_network_remotes__parsing, 9},
	{"refspec_parsing", &test_network_remotes__refspec_parsing, 9},
	{"fnmatch", &test_network_remotes__fnmatch, 9},
	{"transform", &test_network_remotes__transform, 9},
	{"find_invalid_chars_in_oid", &test_object_raw_chars__find_invalid_chars_in_oid, 10},
	{"build_valid_oid_from_raw_bytes", &test_object_raw_chars__build_valid_oid_from_raw_bytes, 10},
	{"succeed_on_copy_oid", &test_object_raw_compare__succeed_on_copy_oid, 11},
	{"succeed_on_oid_comparison_lesser", &test_object_raw_compare__succeed_on_oid_comparison_lesser, 11},
	{"succeed_on_oid_comparison_equal", &test_object_raw_compare__succeed_on_oid_comparison_equal, 11},
	{"succeed_on_oid_comparison_greater", &test_object_raw_compare__succeed_on_oid_comparison_greater, 11},
	{"compare_fmt_oids", &test_object_raw_compare__compare_fmt_oids, 11},
	{"compare_allocfmt_oids", &test_object_raw_compare__compare_allocfmt_oids, 11},
	{"compare_pathfmt_oids", &test_object_raw_compare__compare_pathfmt_oids, 11},
	{"succeed_on_oid_to_string_conversion", &test_object_raw_convert__succeed_on_oid_to_string_conversion, 12},
	{"succeed_on_oid_to_string_conversion_big", &test_object_raw_convert__succeed_on_oid_to_string_conversion_big, 12},
	{"fail_on_invalid_oid_string", &test_object_raw_fromstr__fail_on_invalid_oid_string, 13},
	{"succeed_on_valid_oid_string", &test_object_raw_fromstr__succeed_on_valid_oid_string, 13},
	{"hash_by_blocks", &test_object_raw_hash__hash_by_blocks, 14},
	{"hash_buffer_in_single_call", &test_object_raw_hash__hash_buffer_in_single_call, 14},
	{"hash_vector", &test_object_raw_hash__hash_vector, 14},
	{"hash_junk_data", &test_object_raw_hash__hash_junk_data, 14},
	{"hash_commit_object", &test_object_raw_hash__hash_commit_object, 14},
	{"hash_tree_object", &test_object_raw_hash__hash_tree_object, 14},
	{"hash_tag_object", &test_object_raw_hash__hash_tag_object, 14},
	{"hash_zero_length_object", &test_object_raw_hash__hash_zero_length_object, 14},
	{"hash_one_byte_object", &test_object_raw_hash__hash_one_byte_object, 14},
	{"hash_two_byte_object", &test_object_raw_hash__hash_two_byte_object, 14},
	{"hash_multi_byte_object", &test_object_raw_hash__hash_multi_byte_object, 14},
	{"oid_shortener_no_duplicates", &test_object_raw_short__oid_shortener_no_duplicates, 15},
	{"oid_shortener_stresstest_git_oid_shorten", &test_object_raw_short__oid_shortener_stresstest_git_oid_shorten, 15},
	{"validate_oid_size", &test_object_raw_size__validate_oid_size, 16},
	{"convert_type_to_string", &test_object_raw_type2string__convert_type_to_string, 17},
	{"convert_string_to_type", &test_object_raw_type2string__convert_string_to_type, 17},
	{"check_type_is_loose", &test_object_raw_type2string__check_type_is_loose, 17},
	{"retrieve_tree_from_path_to_treeentry", &test_object_tree_frompath__retrieve_tree_from_path_to_treeentry, 18},
	{"fail_when_processing_an_unknown_tree_segment", &test_object_tree_frompath__fail_when_processing_an_unknown_tree_segment, 18},
	{"fail_when_processing_an_invalid_path", &test_object_tree_frompath__fail_when_processing_an_invalid_path, 18},
...
static const struct clay_suite _all_suites[] = {
	...
	{
        "network::remotes",
        {"initialize", &test_network_remotes__initialize, 9},
        {"cleanup", &test_network_remotes__cleanup, 9},
        &_all_callbacks[24], 4
    },
	{
        "object::raw::chars",
    ...
    },
	{
        ...
        {"initialize", &test_object_tree_frompath__initialize, 18},
        {"cleanup", &test_object_tree_frompath__cleanup, 18},
        &_all_callbacks[58], 3
    },
	{
        "status::single",
...
static const char _suites_str[] = "core::dirent, core::filebuf, core::oid, core::path, core::rmdir, core::string, core::strtol, core::vector, index::rename, network::remotes, object::raw::chars, object::raw::compare, object::raw::convert, object::raw::fromstr, object::raw::hash, object::raw::short, object::raw::size, object::raw::type2string, object::tree::frompath, status::single, status::worktree";
